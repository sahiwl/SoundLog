  ...
  return (
    <div className="mt-8 bg-grids rounded p-4">
      <div className="flex items-center mb-4">
        <div className="w-12 h-12 rounded-full mr-4 shrink-0">
          {authUser?.profilePic?.trim() ? (
            <img
              src={authUser.profilePic.trim()}
              alt=""
              className="w-full h-full rounded-full object-cover"
            />
          ) : (
            <div className="w-full h-full rounded-full bg-gray-500 flex items-center justify-center text-lg font-medium text-white">

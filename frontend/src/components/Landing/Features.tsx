...
const RatingStar = ({ filled }: RatingStarProps) => (
  <svg
    className={`w-7 h-7 ${filled ? "text-green-500" : "text-gray-600"}`}
    fill="currentColor"
    viewBox="0 0 20 20"
    ...
    <div className="max-w-7xl mx-auto px-6 space-y-24">
      <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="text-center md:text-left">
          ...
          <p className="text-lg text-gray-400 leading-relaxed">
            Keep a diary of your music listening. Rate albums on a five-star
            scale, write detailed reviews, and log the dates you listen. Never
            forget an album again.
          </p>
        </div>
        ...
        <div className="bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-700/50 transform transition-transform duration-300 hover:scale-105 hover:shadow-purple-500/20">
          <div className="flex items-center space-x-5">
            <img
              ...
              alt="Album Art: SOUR by Olivia Rodrigo"
              className="w-24 h-24 sm:w-32 sm:h-32 rounded-lg shadow-md shrink-0"
            />
            <div>
      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        <div className="text-center md:text-left md:order-last">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Curate beautiful lists.
          </h2>
          <p className="text-lg text-gray-400 leading-relaxed">
            Compile and share lists of albums for any occasion. Your all-time
            favorites, the best of 2025, or the perfect soundtrack for a rainy
            day.
          </p>
        </div>
        ...
        <div className="bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-700/50 transform transition-transform duration-300 hover:scale-105 hover:shadow-green-500/20">
          ...
          <div className="flex items-center -space-x-5">
            <img
              src="https://realgroovy-media.s3.ap-southeast-2.amazonaws.com/product/194399969915/194399969915.jpg"
              alt="The Melodic Blue"
            ...
            <img
              src="https://i.scdn.co/image/ab67616d0000b273a91c10fe9472d9bd89802e5a"
              alt="SOUR album cover"
              className="w-20 h-20 rounded-full object-cover border-4 border-gray-800 shadow-lg"
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSG563E6p5rw9Qg98N8M53jGTyu2tiAj9oHQA&s"
              alt="Back in Black cover"
              className="w-20 h-20 rounded-full object-cover border-4 border-gray-800 shadow-lg"
            />
          </div>
          <p className="text-sm text-gray-400 mt-5 italic">
            + many more trending albums
          </p>

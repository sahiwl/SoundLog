...
const mockReviews: MockReview[] = [
  {
    ...
    review:
      "This is exactly what I've been looking for. It's like Letterboxd but for my music obsession. Finally, I can log all my listens!",
    albumArt:
  ...
  },
  {
    ...
    review:
      "Creating and sharing lists of my favorite albums has never been easier. The community is great and I'm discovering so much new music.",
    albumArt:
    ...
    <div className="max-w-5xl mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {mockReviews.map((review) => (
          <div
            key={review.id}
            className="bg-gray-800 p-8 rounded-2xl shadow-xl border border-gray-700/50"
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <img
                src={review.albumArt}
                alt="Reviewed album"
                className="w-14 h-14 rounded-lg shadow-md hidden sm:block"
              />
            </div>
          </div>
        ))}

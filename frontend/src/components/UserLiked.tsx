...
import type { PaginatedAlbumsResponse } from "../types/api";

const UserLiked = () => {
  const [userLikedAlbums, setUserLikedAlbums] = useState<Album[]>([]);
  ...
  useEffect(() => {
    const fetchUserLikes = async () => {
      ...
      try {
        ...
        const response = await axiosInstance.get<PaginatedAlbumsResponse>(
          `/pages/${authUser.username}/likes`,
